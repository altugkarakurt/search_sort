from utils import logrange, time_search, test_search
from python_search_sort.py_search import py_binary_search, py_linear_search

import matplotlib.pyplot as plt
import json

BIT_CNT = 8 # 8-bit or 32-bit integers
...
def test_search_all():
    test_search([py_binary_search, py_linear_search,c_binary_search,c_bsearch,c_linear_search], bit_cnt=BIT_CNT)


def compare_search_all():
    """--------------------------------------------------------------------
        Binary Search
    --------------------------------------------------------------------"""
    # Parameters
